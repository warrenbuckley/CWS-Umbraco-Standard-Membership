...
@using (Html.BeginUmbracoForm<MemberEditController>("HandleChangePassword", FormMethod.Post))
{
    ...
    <div class="form-group">
        ...
        @Html.ValidationMessageFor(model => model.CurrentPassword, null, new { @class = "help-block" } )
    </div>
